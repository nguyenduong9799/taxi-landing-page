            ...
            <div className="row">
              <div className="col-xxl-6 col-xl-6 col-lg-6">
                <div className="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                  ...
                  <div className="cta__content">
                    <h3 className="cta__title">Đăng kí đối tác tài xế</h3>
                    <p>
                      Teach what you love. Learned gives you neccessary tools to
                      become an instructor.
                    </p>
                    <Link href="/contact">
                      <a className="tp-btn tp-btn-3">Liên hệ</a>
                    </Link>
                  </div>
                </div>
              </div>
              <div className="col-xxl-6 col-xl-6 col-lg-6">
                <div className="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                  ...
                  <div className="cta__content">
                    <h3 className="cta__title">Đăng kí đối tác vận tải</h3>
                    <p>
                      Course completed? Then its time apply the certificate Do
                      it in simplesteps with Learned.
                    </p>
                    <Link href="/contact">
                      <a className="tp-btn tp-btn-4">Liên hệ ngay</a>
                    </Link>
                  </div>
                </div>
              </div>

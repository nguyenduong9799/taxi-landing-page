  ...
  const featuresData = [
    {
      ...
      title: "Gọi điện, có xe ngay",
      description: "Nhấc điện thoại gọi nghe, sẽ có xe trong giây lát",
    },
    {
      id: 2,
      icon_img: (
      ...
      title: "Luôn sẵn sàng",
      description: "Luôn có sẵn xe để phục vụ khách hàng",
    },
    {
      id: 3,
      icon_img: (
      ...
      title: "Lắng nghe trải nghiệm khách hàng",
      description:
        "Lăng nghe các phản hồi và ý kiến khách hàng về dịch vụ, nâng cao chất lượng",
    },
  ];
  return (
    <>

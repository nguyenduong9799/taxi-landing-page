            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4">
              <div className="brand__wrapper">
                <div className="section__title-wrapper-2">
                  <span className="section__title-pre-2">Đối tác</span>
                  <h3 className="section__title-2 section__title-2-30">
                    Đối tác thân thiết
                  </h3>
                </div>
                <p>
                  You can list your partners or instructors brands here to show
                  off your sites reputation
                </p>

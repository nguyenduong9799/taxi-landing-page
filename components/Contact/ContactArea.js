                  ...
                  <form action="#">
                    <div className="row">
                      ...
                      <div className="col-xxl-12">
                        <div className="contact__form-input">
                          <input required type="text" placeholder="Chủ đề" />
                        </div>
                      </div>
                      <div className="col-xxl-12">
                        <div className="contact__form-input">
                          <textarea
                            required
                            placeholder="Điền thông tin cần trao đổi"
                          ></textarea>
                        </div>
                      </div>
                      <div className="col-xxl-12">
                        <div className="contact__form-agree  d-flex align-items-center mb-20">
                          ...
                          <label className="e-check-label" htmlFor="e-agree">
                            Tôi đồng ý<a href="#">Quy tắc & điều kiện</a>
                          </label>
                        </div>
                      </div>
                      <div className="col-xxl-12">
              ...
              <div className="contact__info white-bg p-relative z-index-1">
                ...
                <div className="contact__info-inner white-bg">
                    ...
                    <li>
                      <div className="contact__info-item d-flex align-items-start mb-35">
                        ...
                        <div className="contact__info-text">
                          <h4>Email liên hệ</h4>
                          <p>
                            <a href="mailto:support@taxi.com">
                              support@taxi.com
                            </a>
                          </p>
                          <p>
                            <a href="mailto:info@taxi.com"> info@etaxi.com</a>
                          </p>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div className="contact__info-item d-flex align-items-start mb-35">
                        ...
                        <div className="contact__info-text">
                          <h4>Holine</h4>
                          <p>
                            <a href="tel:+84123456789">+84123456789</a>
                          </p>
                          <p>
                            <a href="tel:+84123456789">+84123456789</a>
                          </p>
                  ...
                  <div className="contact__social pl-30">
                    <h4>Theo dõi chúng tôi trến các nền tảng</h4>
                    <ul>
                      <li>
                        <a href="#" className="fb">

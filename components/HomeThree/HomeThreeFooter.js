              ...
              <div className="row">
                    ...
                    <div className="footer__widget-content">
                      <div className="footer__widget-info">
                        <div className="footer__subscribe footer__subscribe-3">
                          <p>
                            Educal University does not discriminate on the basis
                            of race, nationa.
                          </p>
                          <form action="#">
                ...
                <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-5">
                  <div className="footer__widget footer__widget-3 footer-col-3-2 mb-50">
                    <h3 className="footer__widget-title footer__widget-title-3">
                      Explore
                    </h3>
                    <div className="footer__widget-content">
                      <ul>
                    ...
                    <div className="footer__contact">
                      <ul>
                        ...
                        <li>
                          <p>International:</p>
                          <h4>
                            <a href="tel:088-234-567-899">+(088) 234 567 899</a>
                          </h4>
                        </li>
                        <li>
                          <p>International:</p>
                          <h4>
                            <a href="mailto:info@taxi.com">info@taxi.com</a>
                          </h4>
                        </li>
                      </ul>
                    </div>
